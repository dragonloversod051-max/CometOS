...
- An interactive family tree which displays information for any member selected
- The current date and time in the top bar
- A battery detector with custom text
- All apps and windows are draggable, for easy use and accessibility
